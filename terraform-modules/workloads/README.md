...
| <a name="module_kubernetes_cluster"></a> [kubernetes\_cluster](#module\_kubernetes\_cluster) | git::https://github.com/Unique-AG/terraform-modules.git//modules/azure-kubernetes-service | vsc589-tan-moaning-panda |
